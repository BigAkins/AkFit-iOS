...
-- Purpose:   Improve search matching and expand food coverage.
--
-- Changes:
--   1. Update search_text normalization to also strip commas (aligns with
--      the iOS normalizeForSearch update). Re-populate all existing rows.
--   2. Add missing fruits: papaya, mango, watermelon, peach, plum,
--      nectarine, pear, cherries, coconut, passion fruit, guava,
--      dragon fruit, lychee, pomegranate, persimmon
--   3. Add sliced/half fruit variations for common fruits
--   4. Add chia seeds, honey, agave, maple syrup
--   5. Add protein pudding, generic protein powder
--   6. Add singular-named fruit aliases for better matching
--
-- Source: USDA FoodData Central (SR Legacy / Foundation Foods).
--         Source field = 'usda'; brand = NULL.
--
-- Note: search_text auto-populated via updated trigger.
-- =============================================================================
